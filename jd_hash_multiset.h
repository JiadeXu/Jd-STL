/*************************************************************************
	> File Name: jd_hash_multiset.h
	> Author: 
	> Mail: 
	> Created Time: Sat Oct  2 21:47:08 2021
 ************************************************************************/

#ifndef _JD_HASH_MULTISET_H
#define _JD_HASH_MULTISET_H
...
public:
	...
	hash_multiset(size_type n, const hasher &hf, const key_equal &eq): rep(n, hf, eq) {}
