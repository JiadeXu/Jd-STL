/*************************************************************************
	> File Name: jd_hash_map.h
	> Author: 
	> Mail: 
	> Created Time: Sat Oct  2 21:08:43 2021
 ************************************************************************/

#ifndef _JD_HASH_MAP_H
#define _JD_HASH_MAP_H
...
public:
	...
	hash_map(size_type n, const hasher &hf, const key_equal &eq): rep(n, hf, eq) {}
